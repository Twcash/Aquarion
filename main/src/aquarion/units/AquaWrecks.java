...
public class AquaWrecks {
    ...
    public static void loadContent() {
        ...
        curatorWreck = new DerelictUnitType("curator-wreck"){{ constructor = UnitEntity:: create; outlines = false; targetable = false;}};
        gossWreck = new DerelictUnitType("goss-wreck"){{ constructor = UnitEntity:: create;targetable = false;}};
        custodianWreck = new DerelictUnitType("custodian-wreck"){{ constructor = UnitEntity:: create;targetable = false;}};
