...
block.aquarion-huge-polymer-wall.name = Huge Polymer Wall
...
block.aquarion-huge-cupronickel-wall.name = Huge Cupronickel Wall
...
block.aquarion-torrefy.description = Fires a massive plasma jet at enemies.
block.aquarion-maelstrom.details = Need more be said?
...
block.aquarion-mend-pyre.description = Repairs structures over time. Necessary to upkeep pipe melting. Uses power to operate.
block.aquarion-mend-pyre.details = Does not use magma to operate.
block.aquarion-mend-pylon.name = Mend Pylon
block.aquarion-mend-pylon.description = Repairs structures over time. Necessary to upkeep pipe melting. Uses fumes and power to operate.
...
block.aquarion-spore-processor.name = Spore Processor
block.aquarion-spore-processor.description = Blends spore pods into a slurry.
block.aquarion-coal-liquefactor.name = Coal Liquefactor
block.aquarion-coal-liquefactor.description = Creates synthetic oil from coal, oxygen, and heat.
...
block.aquarion-fume-seperator.name = Fume Seperator
block.aquarion-fume-seperator.description = Cracks [#83746b]Fumes[] into some of its usable components.
block.aquarion-lead-burner.name = Lead Burner
block.aquarion-lead-burner.description = Uses the exothermic oxidative reaction between lead and air to generate power.
block.aquarion-geothermal-evaporator.name = Geothermal Evaporator
block.aquarion-geothermal-evaporator.description = Uses geothermal heat to boil halidic water into muriatic acid and salt.
block.aquarion-nuetralization-vessel.name = Nuetralization Vessel
block.aquarion-nuetralization-vessel.description = Uses acid nuetralization with the basic hydroxide to produce halidic water and heat.
block.aquarion-scrap-centrifuge.name = Scrap Centrifuge
block.aquarion-scrap-centrifuge.description = Uses centrifugal force to separate some of scrap's basic materials.
block.aquarion-ultramafic-refinery.name = Ultramafic Refinery
block.aquarion-ultramafic-refinery.description = Grinds down Serpentine into it's basic materials.
block.aquarion-biotite-leaching-vessel.name = Biotite Leaching Vessel
block.aquarion-biotite-leaching-vessel.description = Uses muriatic acid to decompose biotite into more simpler materials.
...
block.aquarion-stone-rock.name = Stone Rock
block.aquarion-large-stone-rock.name = Large Stone Rock
block.aquarion-huge-stone-rock.name = Huge Stone Rock
block.aquarion-massive-stone-rock.name = Massive Stone Rock

block.aquarion-defunct-generator.name = Generator
block.aquarion-defunct-dril.namel = Drill
block.aquarion-defunct-wall-small.name = Small Wall
block.aquarion-defunct-wall.name = Wall
block.aquarion-nostalgia.name = Nostalgia
...
item.aquarion-zinc.name = Zinc
item.aquarion-zinc.description = A brittle metallic element similar to magnesium, resistant to corrosion.
item.aquarion-biotite.name = Biotite
item.aquarion-biotite.description = A mica family found in igneous and metamorphic rocks. Contains ferric oxide and aluminum.
item.aquarion-biotite.details = Composition seems to be mainly of Annite, a phyllosilicate mineral with a hydroxyl group that can be repurposed into hydroxide.
item.aquarion-bauxite.name = Bauxite
item.aquarion-bauxite.description = A ferric aluminosilicate. Used for procuring aluminum.
item.aquarion-bauxite.details = An Overrated aluminum material. Truly Cryolite is better in every way.
...
liquid.aquarion-chlorine.description = A halide group element.
...
sector.aquarion-erodedCanyon.name = Eroded Canyon
...
unit.aquarion-weld.name = Weld
block.aquarion-weld.name = Weld
unit.aquarion-weld.description = A slow-moving naval unit that fires electric arcs at enemies.
...
## MESSAGES
resurgence-welcome = This is [#815da2]Serpulo[].
resurgence-defunct-introduction = These are defunct relics from our collective Ally.\nThey still seem to work. utilizing these abandoned machines can speed up expansion.
resurgence-tutorial-lead = Lead is required to build conveyors. Deconstruct abandoned structures or manually mine to obtain some.
resurgence-tutorial-nickel = Nickel was not utilized by our collective ally. This will have to be manually mined or deconstructing stone debris to obtain some.
resurgence-tutorial-solar = Obtaining nickel means that we can generate our own power. Build a solar genarator.
resurgence-tutorial-harvester = With our own power, we can construct our own harvesters to mine nickel.
resurgence-tutorial-outlets-1 = Unlike our predecessors. We cannot directly connect to buildings.
resurgence-tutorial-outlets-2 = Construct outlets facing towards power consuming buildings to fuel them.
resurgence-tutorial-outlets-3 = Outlets have a set throughput.\n Use the [accent]:Core Database:[] to know this outlet's max throughput.
resurgence-tutorial-refund = For future reference: any structure deconstructed will return all of its original material value.
resurgence-tutorial-enemy = Crux automatic threat detection has sent a scouting party.\n Abandoned structures cannot hold off enemies forever...\nWe will have to reinforce them with our own defenses.
resurgence-tutorial-burner-1 = Solar generators fluctuate with daylight. A more stable power source is reccomended.
resurgence-tutorial-burner-2 = Lead burners consume air and lead to produce some stable power and minium as a by-product.
resurgence-tutorial-burner-3 = Lead is mined of course. However, we have to build and power the air intakes.
resurgence-tutorial-copper = Copper is another valuable resource needed for more advanced technology.
resurgence-tutorial-respite = Further enemy invasions will happen soon.\n We must expand our infrastructure to strengthen our defense.
resurgence-tutorial-retaliation = With the loss of a scouting party, Crux forces has deemed this location to be under attack.\nA stronger Crux branch will send exponentially stronger waves of enemies until their resources are exhausted.
resurgence-tutorial-metaglass-1 = Our defenses must always be stronger than the future enemy waves.\n Exploring better technology will be to our advantage.
resurgence-tutorial-metaglass-2 = Metaglass is the next-in-line resource for superior infrastructure.
resurgence-tutorial-graphite = With metaglass, centrifugal pumps can now be constructed to pump water and other liquid resources.\nWater is essential to obtain graphite.
