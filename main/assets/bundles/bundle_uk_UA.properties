...
block.aquarion-huge-zinc-wall.name = Huge Zinc Wall
block.aquarion-huge-zinc-wall.description = Protects structures from enemy projectiles.
...
block.aquarion-lead-burner.description = Uses heat from lead oxidation to generate a tiny amount of power. Minium is produced as a by-product.
...
block.aquarion-nuetralization-vessel.description = Uses acid nuetralization with hydroxide to produce excess heat and salt.
...
block.aquarion-azurite-large.name = Azurite Crystals
...
item.aquarion-minium.name = Minium
item.aquarion-minium.description = Lead oxide, used in protective coatings, batteries, and as a catalyst in metaglass production.
