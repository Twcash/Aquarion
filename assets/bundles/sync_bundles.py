...
ERROR = f"{BcColors.FAIL}ERROR{BcColors.ENDC}: "
WARN = f"{BcColors.WARNING}WARNING{BcColors.ENDC}: "
PASS = f"{BcColors.OKGREEN}OK{BcColors.ENDC}: "
...
if input(f"Is this correct? (y/N): ").lower() != "y":
    print(f"{ERROR}ABORTED - WHY RUN THE SCRIPT GENIUS")
    exit(1)
