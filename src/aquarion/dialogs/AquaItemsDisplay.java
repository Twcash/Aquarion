...
public class AquaItemsDisplay extends ItemsDisplay {
    boolean collapsed;

    public AquaItemsDisplay(){
        rebuild(new ItemSeq());
    }
        ...
        table(Tex.button, c -> {
            ...
            Collapser col = new Collapser(base -> base.pane(t -> {
                ...
                for(Item item : content.items()){
                    ...
                    t.add(item.localizedName).color(Color.scarlet.lerp(Pal.heal, Mathf.clamp(items.total / 10000f))).left();
                    t.row();
            ...
            col.setCollapsed(collapsed, true);
