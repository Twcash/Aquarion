...
public class CoradumPlanetGenerator extends PlanetGenerator{
    public float heightScl = 0.65f, octaves = 7, persistence = 0.7f, heightPow = 4.5f, heightMult = 1.2f;

    //TODO inline/remove
    public static float arkThresh = 0.28f, arkScl = 0.83f;
    public static int arkSeed = 7, arkOct = 2;
    public static float liqThresh = 0.21f, liqScl = 65f, redThresh = 3.1f, noArkThresh = 0.3f;
    ...
    Block[] terrain = {Blocks.slag, Blocks.slag, Blocks.carbonStone, Blocks.yellowStone, Blocks.darkMetal, Blocks.darkPanel1, Blocks.darkPanel2, Blocks.darkPanel3, Blocks.darkPanel4, Blocks.darkPanel5, Blocks.darkPanel6, Blocks.metalFloor, Blocks.metalFloor2, Blocks.metalFloor3, Blocks.metalFloor4};
    ...
    float rawHeight(Vec3 position){
        return Simplex.noise3d(seed, octaves, persistence, 1f/heightScl, position.x, position.y, position.z);
    }
    ...
    Block getBlock(Vec3 position){
        ...
        if(ice < redThresh - noArkThresh && Ridged.noise3d(seed + arkSeed, position.x , position.y , position.z , arkOct, arkScl) > arkThresh){
            //TODO arkyic in middle
            result = Blocks.metalFloor;
        }
    ...
    public void genTile(Vec3 position, TileGen tile){
        ...
        if(Ridged.noise3d(seed + 2, position.x, position.y, position.z, 3, 6f) > 0.6){
