...
public class HeatGenerator extends ConsumeGenerator {
    ...
    public void setBars(){
        ...
        addBar("instability", (HeatGenBuild entity) -> new Bar("bar.instability", Pal.sap, () -> entity.instability));

        addBar("heat", (HeatGenBuild entity) ->
                new Bar(() ->
    ...
    public class HeatGenBuild extends ConsumeGeneratorBuild implements HeatConsumer{
