...
public class NewParticleEffect extends Effect{
    ...
    public float offsetX, offsetY; //middle fringer
    public float x, y;
    ...
    public void render(EffectContainer e){
        ...
        float ox = e.x + Angles.trnsx(realRotation, offsetX * flip, offsetY) + x, oy = e.y + Angles.trnsy(realRotation, offsetX * flip, offsetY) + y;
