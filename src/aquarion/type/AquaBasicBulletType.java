...
public class AquaBasicBulletType extends AquaBulletType{
    ...
    public AquaBasicBulletType(float speed, float damage, String bulletSprite){
        super(speed, damage);
        this.sprite = bulletSprite;
    }

    public AquaBasicBulletType(float speed, float damage){
        this(speed, damage, "bullet");
    }

    /** For mods. */
    public AquaBasicBulletType(){
        this(1f, 1f, "bullet");
    }
